...
const (
	...
	func newHbacRuleGrantFromEntry(hbacRuleResource *v2.Resource, entry *ldap3.Entry) (*v2.Grant, error) {
		...
		return nil, fmt.Errorf("baton-ipa: unsupported object class: %s", strings.Join(entry.GetAttributeValues("objectClass"), ", "))
	}
*/
